...
function buildData(seed=42){
  const R=seedRng(seed),G=()=>gaussR(R);
  const A=[{sym:"PETR4",name:"Petrobras",sector:"Energia",market:"B3",base:38,vol:.025},{sym:"VALE3",name:"Vale",sector:"Mineração",market:"B3",base:62,vol:.022},{sym:"ITUB4",name:"Itaú",sector:"Financeiro",market:"B3",base:32,vol:.018},{sym:"WEGE3",name:"WEG",sector:"Industrial",market:"B3",base:44,vol:.02},{sym:"BBDC4",name:"Bradesco",sector:"Financeiro",market:"B3",base:14,vol:.02},{sym:"AAPL",name:"Apple",sector:"Tech",market:"US",base:195,vol:.015},{sym:"MSFT",name:"Microsoft",sector:"Tech",market:"US",base:420,vol:.014},{sym:"NVDA",name:"NVIDIA",sector:"Tech",market:"US",base:880,vol:.035},{sym:"GOOGL",name:"Alphabet",sector:"Tech",market:"US",base:175,vol:.016},{sym:"AMZN",name:"Amazon",sector:"Tech",market:"US",base:185,vol:.018},{sym:"BTC",name:"Bitcoin",sector:"Crypto",market:"Crypto",base:67000,vol:.04},{sym:"ETH",name:"Ethereum",sector:"Crypto",market:"Crypto",base:3500,vol:.045},{sym:"SOL",name:"Solana",sector:"Crypto",market:"Crypto",base:170,vol:.06}];
